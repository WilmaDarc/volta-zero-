...
def main():
    st.set_page_config(
        ...
        page_icon="C:\\EBAC CIENCIA DE DADOS\telmarketing_icon.png",     
        layout="wide",
    ...
    # SIDEBAR
    image = Image.open(fp='C:\EBAC CIENCIA DE DADOS\Bank-Branding.jpg')
    ...
    <div style="text-align:center">
        <a href="https://github.com/WilmaDarc">
            <img src="https://private-user-images.githubusercontent.com/239690793/526791743-a97f624f-2fed-4eb9-941b-1f07df4d9811.png?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJnaXRodWIuY29tIiwiYXVkIjoicmF3LmdpdGh1YnVzZXJjb250ZW50LmNvbSIsImtleSI6ImtleTUiLCJleHAiOjE3NjU4Mzc3MTUsIm5iZiI6MTc2NTgzNzQxNSwicGF0aCI6Ii8yMzk2OTA3OTMvNTI2NzkxNzQzLWE5N2Y2MjRmLTJmZWQtNGViOS05NDFiLTFmMDdkZjRkOTgxMS5wbmc_.sQnqa0dV7UwVF4C4nIGAEiB2kAGJ_G5j9PpNv-flO6o" alt="ebac_logo-data_science" width=100%>
        </a>
    </div> 
    ...
    **Aluna:** [Wilma Darc Alves de Farias](https://www.linkedin.com/feed)<br>
    **Data:** 15 de dezembro de 2025.
    ...
    if data_file_1 is not None:
        ...
        file_data = r"C:\EBAC CIENCIA DE DADOS\input\bank-additional-full.csv"
        bank_raw = load_data(file_data=file_data, sep=";")
